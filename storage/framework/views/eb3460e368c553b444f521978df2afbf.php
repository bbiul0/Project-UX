		...
		<div class="d-flex pt-3 align-items-start">
			<?php if(count($books) == 0): ?>
				<div class="alert alert-warning text-center p-5" role="alert">
					...
					<br>
					<p class="fw-bolder">We dont have books from <?php echo e($key->name); ?> for now</p>
				</div>
...
</html><?php /**PATH C:\Users\chynt\laragon\www\Bookstore git\BookStoreWFD\resources\views/author.blade.php ENDPATH**/ ?>