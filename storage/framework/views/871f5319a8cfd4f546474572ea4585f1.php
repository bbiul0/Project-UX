...
<?php $component->withAttributes([]); ?>
	<div class = "row g-0 mt-5 ">
        <div class="align-items-center">
            ...
            Search Result For <?php echo e($key); ?>
		...
		<div class="d-flex pt-3 align-items-start">
			<?php if(count($books) == 0): ?>
				<div class="alert alert-warning text-center p-5" role="alert">
					...
					<br>
					<p>The Key <?php echo e($key); ?> didn't match to any books in the database</p>
				</div>
		...
		<div class="col-lg-2 ms-auto">
			<div class="category" style="width: 200px">
				...
				<div class="list-group mt-5" style="width: 200px">
					...
					<?php $__currentLoopData = $authors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<a href="/author/<?php echo e($author->id); ?>" 
...
</html><?php /**PATH C:\Users\chynt\laragon\www\Bookstore git\BookStoreWFD\resources\views/search.blade.php ENDPATH**/ ?>